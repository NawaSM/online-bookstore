...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($book_name) || empty($author) || empty($isbn) || $price <= 0 || $quantity < 0) {
        ...
        try {
            ...
            header("Location: ../admin/inventory_edit.php?id=" . $book_id);
            exit();
        } catch (Exception $e) {
            $pdo->rollBack();
...
<body>
    <div class="admin-container">
        ...
        <div class="main-content">
            ...
            <form action="../admin/inventory_edit.php?id=<?php echo $book_id; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <?php if (!empty($item['image_data'])): ?>
                        <img src="<?php echo "serve_image.php?type=book&id=" . $item['id']; ?>" 
